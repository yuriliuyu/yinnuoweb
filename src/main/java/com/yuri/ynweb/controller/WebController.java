...
//    @RequestMapping(value = "/product/list/{pageNo}", method = RequestMethod.POST)
//    @ResponseBody
//    public String productList(@PathVariable Integer pageNo, @RequestParam Integer catId, ModelMap resultMap) {
//        if (StringUtils.isEmpty(pageNo)) {
//            logger.error("/product/list缺少参数，pageNo={}", new Object[] { pageNo });
//            BaseJsonResultVO vo = new BaseJsonResultVO();
//            vo.setCode(EnumResCode.SERVER_ERROR.value());
//            vo.setMessage("缺少参数pageNo");
//            return vo;
//        }
//        return null;
//    }
